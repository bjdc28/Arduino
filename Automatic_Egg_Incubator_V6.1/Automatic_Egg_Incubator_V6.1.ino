...
int button4 = 13;
int humidity = 0;
double temp_low = 37.0;                      //Default Temperature - Low cuttoff
double temp_high = 37.5;                     //Default Temperature - High cuttoff
double temperature = 0;
int humidity_low = 21;                  //Default Humidity - Low cuttoff
int humidity_high = 23;                 //Default Humidity - High cuttoff
int setUp = 0;
int cycle = 1;
