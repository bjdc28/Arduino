...
void time() {
  for (int i=0; i<timer; i++){                     //   The for loop, for running the program 500 times.
   ...
   delay(1);                                        //          Writes 20 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
...
for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 19 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 18 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 17 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B0);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 16 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 15 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 14 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 13 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 12 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B0);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 11 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B0);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 10 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B0);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 09 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 08 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 07 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B0);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 06 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 05 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 04 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 03 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 02 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B0);
   digitalWrite(pin4, B1);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 01 to the display.
   digitalWrite(pin1, B0);
   digitalWrite(pin2, B0);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B0);
  ...
  for (int i=0; i<timer; i++){
   ...
   digitalWrite(gnd1, B0);
   digitalWrite(gnd2, B1);
   delay(1);                                        //          Writes 00 to the display.
   digitalWrite(pin1, B1);
   digitalWrite(pin2, B1);
   digitalWrite(pin3, B1);
   digitalWrite(pin4, B0);
